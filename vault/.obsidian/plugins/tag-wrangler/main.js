    ...
    doRecalc() {
        ...
        try {
            try {
                ...
                if (((this.flags |= 16), (this.value = o), (this.lastChanged = D), Y === this))
                    throw o;
            }
        } finally {
            ((this.flags &= -33),
    ...
    ye = class extends ke {
        ...
        hasAllNullValues(e) {
            return this.items.every((t) => {
                ...
                return (
                    n == null ||
                    (e && E(n) && n.value == null && !n.commentBefore && !n.comment && !n.tag)
                );
            });
        }
        hasIn(e) {
...
function Zr({ comment: s, items: e }, t, { flowChars: n, itemIndent: i, onComment: r }) {
    ...
    for (let m = 0; m < e.length; ++m) {
        ...
        if (C(y))
            ...
            w &&
                (w.spaceBefore && h.push(''), fs(t, h, w.commentBefore, !1), w.comment && (u = !0));
    ...
    gs = {
        ...
        resolve(s) {
            let e = new v(parseFloat(s)),
                t = s.indexOf('.');
            return (
                t !== -1 && s[s.length - 1] === '0' && (e.minFractionDigits = s.length - t - 1),
                e
            );
        },
        stringify: $,
...
var Ne = class extends q {
    ...
    toJSON(e, t) {
        ...
        for (let i of this.items) {
            let r, o;
            if (
                (O(i) ? ((r = j(i.key, '', t)), (o = j(i.value, r, t))) : (r = j(i, '', t)),
                n.has(r))
            )
...
function Cs(s, e, t) {
    ...
    let i =
        typeof n == 'function'
            ...
            : (r, o) =>
                  r === o ||
                  (E(r) && E(o) && r.value === o.value && !(r.value === '<<' && s.schema.merge));
...
` + w.comment)
        ...
        if (g === 0) w.comma && i(w.comma, 'UNEXPECTED_TOKEN', `Unexpected , in ${o}`);
            ...
            (w.comma || i(w.start, 'MISSING_CHAR', `Missing , between ${o} items`), w.comment)
        ) {
            let S = '';
            e: for (let N of m)
                switch (N.type) {
...
`) + (o.substring(1) || ' ')),
                ...
                break;
            case '%':
                (((e = s[r + 1]) === null || e === void 0 ? void 0 : e[0]) !== '#' && (r += 1),
                    (n = !1));
                break;
            default:
                (n || (i = !0), (n = !1));
            ...
            if (this.stack.length === 0) yield t;
                ...
                if (
                    ...
                    i &&
                        ...
                        !Tn(i.start) &&
                        (t.indent === 0 ||
                            i.start.every((r) => r.type !== 'comment' || r.indent < t.indent)) &&
                        (n.type === 'document'
                            ? (n.end = i.start)
...
`),
    ...
    updatePage(t, n) {
        var r;
        let i =
            ((r = (0, I.parseFrontMatterAliases)(n)) == null ? void 0 : r.filter(A.isTag)) || [];
    ...
    onMenu(t, n) {
        ...
        if ((this.setupMenu(i, r, o), o)) {
            ...
            i.addItem(
                be('tag-hierarchy', 'vertical-three-dots', 'Collapse tags at this level', () =>
                    u(!0),
                ),
            ).addItem(
                            ...
                            h
                                ...
                                : new Xt()
                                      ...
                                      .then((d) => {
                                          ...
                                          let g =
                                              (p =
                                                  app.internalPlugins.getPluginById(
                                                      'global-search',
                                                  )) == null
                                                  ? void 0
                                                  : p.instance;
