...
var Br = (function () {
    ...
    return (
        ...
        (n.prototype.addTagDefinition = function (e) {
            ...
            if (t !== e) {
                if (t)
                    throw new Error('A tag is already defined using the name '.concat(t.tagName));
...
var io = (function () {
    ...
    return (
        ...
        (n.prototype._parseLinkTagUrlDestination = function (e, t, r, i) {
            ...
            return c
                ? (this._parserContext.log.addMessageForTokenSequence(v.LinkTagInvalidUrl, c, l, i),
                  !1)
        ...
        (n.prototype._parseMemberReference = function (e, t, r, i) {
            ...
            if (
                ...
                ((o.memberIdentifier = this._parseMemberIdentifier(e, r, i)), !o.memberIdentifier)
            )
                return;
            if (
                ...
                if (((o.selector = this._parseMemberSelector(e, o.colonExcerpt, i)), !o.selector))
                    return;
        ...
        (n.prototype._parseHtmlStartTag = function (e) {
            ...
            if (yn(o))
                return this._backtrackAndCreateErrorForFailure(e, t, 'Invalid HTML element: ', o);
            for (
        ...
        (n.prototype._parseFencedCode = function (e) {
            ...
            for (var o = e.extractAccumulatedSequence(); e.peekTokenKind() === u.Spacing; )
                e.readToken();
...
function Xr(n, e) {
    ...
    var b = w.reduce(function (S, k) {
        return (
            (S[k] = He(n, { placement: k, boundary: i, rootBoundary: o, padding: a })[ge(k)]),
            S
        );
    }, {});
        ...
        add_syntax_highlighting_settings() {
            ...
            (t.append(
                ...
                new L.Setting(this.containerEl)
                    ...
                    .setDesc(t)
                    .addToggle((r) => {
                        r.setValue(this.plugin.settings.syntax_highlighting_mobile).onChange(
                            (i) => {
                            ...
                            .addSearch((a) => {
                                (new on(a.inputEl, this.plugin, $e.TemplateFiles),
                                    a
                                        ...
                                        .setValue(r.template)
                                        .onChange((l) => {
                                            ((this.plugin.settings.folder_templates[i].template =
                                                l),
                                                this.plugin.save_settings());
                                        }),
                                    a.containerEl.addClass('templater_search'));
    ...
    pi = class extends be {
        ...
        generate_rename() {
            return async (e) => {
                ...
                return (
                    await this.plugin.app.fileManager.renameFile(this.config.target_file, t),
                    ''
                );
            };
        }
        ...
        web: {
            ...
            functions: {
                daily_quote: {
                    ...
                    examples: [
                        { name: 'Daily quote', example: '<% await tp.web.daily_quote() %>' },
                    ],
                },
                random_picture: {
                    name: 'random_picture',
    ...
    (n.defineMode('javascript', function (e, t) {
        ...
        return {
            ...
            indent: function (s, p) {
                ...
                return ve == 'vardef'
                    ? x.indented +
                          (s.lastType == 'operator' || s.lastType == ',' ? x.info.length + 1 : 0)
                    : ve == 'form' && A == '{'
                      ? x.indented
                      : ve == 'form'
                        ? x.indented + r
