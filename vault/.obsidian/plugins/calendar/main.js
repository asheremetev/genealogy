...
function appHasPeriodicNotesPluginLoaded() {
    ...
    return (
        periodicNotes &&
        ((_b = (_a = periodicNotes.settings) === null || _a === void 0 ? void 0 : _a.weekly) ===
            null || _b === void 0
            ? void 0
            : _b.enabled)
    );
                ...
                dispose = [
                    ...
                    listen(div1, 'contextmenu', function () {
                        if (is_function(/*onContextMenu*/ ctx[3] && /*contextmenu_handler*/ ctx[9]))
                            /*onContextMenu*/ (ctx[3] && /*contextmenu_handler*/ ctx[9]).apply(
                                this,
                                arguments,
                            );
                    }),
                ...
                dispose = [
                    ...
                    listen(div1, 'contextmenu', function () {
                        if (is_function(/*onContextMenu*/ ctx[4] && /*contextmenu_handler*/ ctx[9]))
                            /*onContextMenu*/ (ctx[4] && /*contextmenu_handler*/ ctx[9]).apply(
                                this,
                                arguments,
                            );
                    }),
