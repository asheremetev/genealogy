...
var _CanvasHelper = class _CanvasHelper {
    ...
    static addCardMenuOption(canvas, element) {
        var _a;
        if (element.id)
            (_a = canvas == null ? void 0 : canvas.cardMenuEl.querySelector(`#${element.id}`)) ==
            null
                ? void 0
                : _a.remove();
        ...
        styleMenuButtonElement.addEventListener('click', () => {
            ...
            for (const stylableAttribute of stylableAttributes) {
                ...
                stylableAttributeElement.addEventListener('click', () => {
                    var _a3;
                    (_a3 = popupMenuElement.querySelector(`#${STYLE_MENU_DROPDOWN_SUBMENU_ID}`)) ==
                    null
                        ? void 0
                        : _a3.remove();
...
var EdgePathfindingSquare = class extends EdgePathfindingMethod {
    getPath() {
        ...
        if (this.fromSide === this.toSide) {
            ...
            BBoxHelper.isHorizontal(this.fromSide) === BBoxHelper.isHorizontal(this.toSide)
        ) {
            let zPath;
                    ...
                    if (isPathCollidingAtTo) {
                        ...
                        const secondToDetourPoint = BBoxHelper.isHorizontal(this.toSide)
                            ? {
                                  ...
                                  y: BBoxHelper.getCenterOfBBoxSide(this.toNodeBBox, connectionSide)
                                      .y,
                              }
                            : {
                                  x: BBoxHelper.getCenterOfBBoxSide(this.toNodeBBox, connectionSide)
                                      .x,
    ...
    getUPath(fromPos, toPos, fromSide, toSide) {
        ...
        if (BBoxHelper.isHorizontal(fromSide)) {
            const xExtremum =
                direction > 0 ? Math.max(fromPos.x, toPos.x) : Math.min(fromPos.x, toPos.x);
            ...
            const yExtremum =
                direction > 0 ? Math.max(fromPos.y, toPos.y) : Math.min(fromPos.y, toPos.y);
...
var NodeStylesExtension = class extends CanvasExtension {
    ...
    onPopupMenuCreated(canvas) {
        ...
        const availableNodeStyles = [
            ...
            (style) =>
                !style.nodeTypes || style.nodeTypes.some((type) => selectedNodeTypes.has(type)),
        );
        CanvasHelper.addStyleAttributesToPopup(
            this.plugin,
            canvas,
    ...
    canvasMetadataCompatibilityEnabled: {
        ...
        children: {
            enableSingleNodeLinks: {
                ...
                description:
                    'When enabled, you can link and embed a node using [[canvas-file#node-id]].',
                type: 'boolean',
            },
        },
    },
            ...
            new import_obsidian4.Setting(nestedContainerEl)
                ...
                .addDropdown((dropdown) => {
                    ...
                    return dropdown
                        ...
                        .setValue(
                            (_a = this.settingsManager.getSetting(settingId)[styleAttribute.key]) !=
                                null
                                ? _a
                                : 'null',
                        )
...
var CanvasPatcher = class extends Patcher {
    async patch() {
        const loadedCanvasViewLeafs = this.plugin.app.workspace
            ...
            .filter(
                (leaf) => !(0, import_obsidian5.requireApiVersion)('1.7.2') || !leaf.isDeferred,
            );
...
var LinkSuggestionsPatcher = class extends Patcher {
    async patch() {
        ...
        const suggestManager =
            (_a = this.plugin.app.workspace.editorSuggest.suggests.find((s) => s.suggestManager)) ==
            null
                ? void 0
                : _a.suggestManager;
        if (!suggestManager)
    ...
    nextNode(canvas) {
        ...
        if (outgoingEdges.length > 1) {
            ...
            const traversedEdgesCount =
                this.visitedNodeIds.filter((visitedNodeId) => visitedNodeId === fromNodeId).length -
                1;
...
var AutoResizeNodeCanvasExtension = class extends CanvasExtension {
    ...
    isValidNodeType(nodeData) {
        return (
            nodeData.type === 'text' || (nodeData.type === 'file' && nodeData.file.endsWith('.md'))
        );
    }
        ...
        this.plugin.registerEvent(
            this.plugin.app.workspace.on(
                ...
                (canvas, event, preventDefault) =>
                    this.onDoubleClick(canvas, event, preventDefault),
            ),
        );
        this.plugin.registerEvent(
            this.plugin.app.workspace.on('advanced-canvas:node-created', (canvas, node) => {
    ...
    init() {
        ...
        this.plugin.addCommand({
            ...
            checkCallback: CanvasHelper.canvasCommand(
                ...
                (canvas) =>
                    this.toggleCollapseGroup(canvas, canvas.selection.values().next().value),
            ),
        });
    }
        ...
        (_a = data == null ? void 0 : data.nodes) == null
            ...
            : _a.forEach((groupNodeData) => {
                  ...
                  const newContainedNodesData = containedNodesData.filter((nodeData) => {
                      ...
                      return !((_c2 =
                          (_b2 =
                              (_a3 = groupNodeData.collapsedData) == null ? void 0 : _a3.nodes) ==
                          null
                              ? void 0
                  ...
                  const newContainedEdgesData = containedEdgesData.filter((edgeData) => {
                      ...
                      return !((_c2 =
                          (_b2 =
                              (_a3 = groupNodeData.collapsedData) == null ? void 0 : _a3.edges) ==
                          null
                              ? void 0
                  ...
                  groupNodeData.collapsedData = {
                      nodes: [
                          ...((_b =
                              (_a2 = groupNodeData.collapsedData) == null ? void 0 : _a2.nodes) !=
                          null
                              ? _b
                              : []),
                      ...
                      edges: [
                          ...((_d =
                              (_c = groupNodeData.collapsedData) == null ? void 0 : _c.edges) !=
                          null
                              ? _d
                              : []),
        ...
        const fileLinksToBeLinkedTo =
            (_b =
                (_a = fileMetadata.frontmatterLinks) == null
                    ? void 0
                    : _a.filter((link) => link.key.split('.')[0] === linkedFilesFrontmatterKey)) !=
            null
                ? _b
                : [];
        const filepathsToBeLinkedTo = fileLinksToBeLinkedTo
            .map((link) =>
                this.plugin.app.metadataCache.getFirstLinkpathDest(link.link, canvasFile.path),
            )
...
async function cloneIFrameElement(iframe) {
    ...
    try {
        if (
            (_a = iframe === null || iframe === void 0 ? void 0 : iframe.contentDocument) ===
                null || _a === void 0
                ? void 0
                : _a.body
        ) {
            ...
            if (unloadedNodes.length === 0) {
                ...
                const filter = (element) => {
                    ...
                    if (
                        ...
                        return false;
                    if (
                        ((_c2 = (_b2 = element.parentElement) == null ? void 0 : _b2.classList) ==
                        null
                            ? void 0
